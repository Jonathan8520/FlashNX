...
- **Mario 63 + Super Mario World Flash (jouable de bout en bout) + Mario Forever Flash + Tetris'd + Flappy Bird + There Is Only One Level + Mario 3D Racing** : tous testés sur hardware. fps stable 55-60 sur la plupart ; Mario 63 en jeu dense est limité par la simulation Ruffle (voir Phase 2.7)

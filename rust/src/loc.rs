...
const EN: Strings = Strings {
    ...
    keys_title: "CONTROLS",
    keys_footer: "A:EDIT   X:P1/P2   B:BACK   UP/DOWN:NAV",
    ...
    fp_title: "FLASHPOINT",
    fp_footer: "A:DOWNLOAD   Y:SORT   +:INFO   ZL+ZR:FILTER {}   B:BACK",
...
const FR: Strings = Strings {
    ...
    keys_title: "TOUCHES",
    keys_footer: "A:\u{00C9}DITER   X:J1/J2   B:RETOUR   HAUT/BAS:NAV",
    ...
    fp_title: "FLASHPOINT",
    fp_footer: "A:T\u{00C9}L\u{00C9}CHARGER   Y:TRIER   +:INFOS   ZL+ZR:FILTRE {}   B:RETOUR",
...
const ES: Strings = Strings {
    ...
    keys_footer: "A:EDITAR   X:J1/J2   B:VOLVER   ARRIBA/ABAJO:NAV",
    ...
    fp_title: "FLASHPOINT",
    fp_footer: "A:DESCARGAR   Y:ORDENAR   +:INFO   ZL+ZR:FILTRO {}   B:VOLVER",
...
const RU: Strings = Strings {
    ...
    keys_title: "КЛАВИШИ",
    keys_footer: "A:ИЗМЕНИТЬ   X:P1/P2   B:НАЗАД   ВВЕРХ/ВНИЗ:НАВ",
    ...
    fp_title: "FLASHPOINT",
    fp_footer: "A:СКАЧАТЬ   Y:СОРТ   +:ИНФО   ZL+ZR:ФИЛЬТР {}   B:НАЗАД",
...
const DE: Strings = Strings {
    ...
    keys_footer: "A:BEARB.   X:S1/S2   B:ZUR\u{00DC}CK   HOCH/RUNTER:NAV",
    ...
    dist_list_footer: "A:STARTEN   X:FLASHPOINT   +:OPTIONEN   L/R:TABS",
    ...
    fp_title: "FLASHPOINT",
    fp_footer: "A:LADEN   Y:SORT.   +:INFO   ZL+ZR:FILTER {}   B:ZUR\u{00DC}CK",
    fp_details_title: "DETAILS",
    ...
    err_https: "HTTPS FEHLGESCHLAGEN ({}). PR\u{00DC}FE UHR, WLAN + URL.",
    ...
    err_no_swf: "KEINE .SWF-DATEI IN DIESEM ARCHIVE.ORG-ELEMENT GEFUNDEN.",
...
const IT: Strings = Strings {
    ...
    keys_title: "COMANDI",
    keys_footer: "A:MODIFICA   X:G1/G2   B:INDIETRO   SU/GI\u{00D9}:NAV",
    ...
    dist_list_footer: "A:AVVIA   X:FLASHPOINT   +:OPZIONI   L/R:SCHEDE",
    ...
    fp_title: "FLASHPOINT",
    fp_footer: "A:SCARICA   Y:ORDINA   +:INFO   ZL+ZR:FILTRO {}   B:INDIETRO",
    ...
    err_https: "HTTPS FALLITO ({}). CONTROLLA L'OROLOGIO, IL WIFI + L'URL.",
    ...
    err_no_swf: "NESSUN FILE .SWF TROVATO IN QUESTO ELEMENTO DI ARCHIVE.ORG.",
...
const PT: Strings = Strings {
    ...
    keys_title: "CONTROLES",
    keys_footer: "A:EDITAR   X:J1/J2   B:VOLTAR   CIMA/BAIXO:NAV",
    ...
    dist_list_footer: "A:INICIAR   X:FLASHPOINT   +:OP\u{00C7}\u{00D5}ES   L/R:ABAS",
    ...
    fp_title: "FLASHPOINT",
    fp_footer: "A:BAIXAR   Y:ORDENAR   +:INFO   ZL+ZR:FILTRO {}   B:VOLTAR",
    ...
    err_https: "FALHA HTTPS ({}). VERIFIQUE O REL\u{00D3}GIO, O WIFI + A URL.",
    ...
    err_no_swf: "NENHUM ARQUIVO .SWF ENCONTRADO NESTE ITEM DO ARCHIVE.ORG.",
    kbd_url_header: "FlashNX - Importar remoto",
